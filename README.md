...
Output file is a tab separated text file containing <b><drug adr start_month end_month prr LowerBoundConfidenceInterval UpperBoundConfidenceInterval Chi-squared numberOfReportInIntervals></i>. An example of output file is showed in the following lines:
```
