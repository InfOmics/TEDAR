...
Output file is a tab separated text file containing <b> <Drug Adr Start_month End_month Prr LowerBoundConfidenceInterval UpperBoundConfidenceInterval Chi-squared NumberOfReportInIntervals> </b>. An example of output file is showed in the following lines:
```
